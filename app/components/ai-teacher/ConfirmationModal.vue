  ...
  <Teleport to="body">
    <Transition name="modal">
      ...
      >
        <!-- Backdrop -->
        <div
          class="absolute inset-0 bg-black/40 backdrop-blur-sm transition-opacity cursor-default"
          @click="handleCancel"
        />
          ...
          <div class="bg-gradient-to-r from-oceanBlue to-deepBlue px-6 py-5">
            <div class="flex items-center gap-3">
              ...
              <button
                ...
                type="button"
                @click="handleCancel"
                class="flex-shrink-0 p-2 rounded-lg hover:bg-white/20 transition-all focus:outline-none focus:ring-2 focus:ring-white/50 cursor-pointer"
                aria-label="Close"
              >
                <Icon
