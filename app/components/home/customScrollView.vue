...
const classLevelPlaceholder = computed(() =>
  contentLayoutLanguage.value === "kiswahili" ? "Chagua darasa" : "Select class level",
);
...
<template>
  <div v-if="userToken">
    ...
    <div id="main-container" tabindex="-1" v-else-if="activeTab === 'interactive-contents'">
      <div v-for="(topics, index) in normalizedGroups" :key="index">
        <div v-if="
        ...
        " class="flex items-center justify-between py-4">
          ...
          <div class="flex items-center gap-2">
            <CustomDropDownList v-if="Array.from(getLevels(topics.data)).length > 1" class="px-2 cursor-pointer"
              ...
              :placeholder="classLevelPlaceholder"
              :list="Array.from(getLevels(topics.data)).map((lvl) => ({
                id: lvl,
                name: lvl,
              }))
                " />
        ...
        <div v-else-if="showGroupHeader(topics) && !seeMoreDetails" class="flex items-center justify-between py-4">
        ...
        <div v-if="hasMultipleGroups">
          ...
          <div v-else-if="!seeMoreDetails" :class="[
            ...
            <TopicCard v-for="topic in (() => {
              ...
              :topic-description="topic.descriptions" :topic-views="topic.viewedBy?.length
                  ? topic.viewedBy?.length
                  : topic.views
                    ? topic.views
                    : 0
    ...
    <div id="main-container" tabindex="-1" v-else-if="activeTab === 'learn-activities'">
      <div v-for="(experiments, index) in normalizedGroups" :key="index">
        <div v-if="
        ...
        <div v-else-if="showGroupHeader(experiments) && !seeMoreDetails" class="flex items-center justify-between py-4">
          <p class="font-bold text-[1.3rem] capitalize">
            {{ (experiments?.dataOfKey as any)?.toLowerCase() }}
          </p>
          <div class="flex items-center gap-2">
            ...
            <CustomDropDownList v-if="Array.from(getLevels(experiments.data)).length > 1" class="px-2 cursor-pointer"
              v-model="currentLevel[(experiments?.dataOfKey as any)?.toLowerCase()]
                "
              :placeholder="classLevelPlaceholder"
              :list="Array.from(getLevels(experiments.data)).map((lvl) => ({
                id: lvl,
                name: lvl,
              }))
                " />
        ...
        <div v-if="hasMultipleGroups">
          ...
          ">
            <template #data>
              ...
              })()" :key="experiment._id" :experiment-id="experiment._id"
                :experiment-thumbnail="experiment.thumbnail" :experiment-description="experiment.description"
                :experiment-type="experiment.category" :experiment-subject="(experiment.subject as any)?.name"
    ...
    <!-- video after login -->
    <div id="main-container" tabindex="-1" v-else-if="activeTab === 'video' || activeTab === 'class-videos'">
      <div v-for="(videos, index) in normalizedGroups" :key="index">
        <div v-if="
        ...
        <div v-else-if="showGroupHeader(videos) && !seeMoreDetails" class="flex items-center justify-between py-4">
          <p class="font-bold text-[1.3rem] capitalize">
            {{ (videos?.dataOfKey as any)?.toLowerCase() }}
          </p>
          <div class="flex items-center gap-2">
            ...
            <CustomDropDownList v-if="Array.from(getLevels(videos.data)).length > 1" class="px-2 cursor-pointer"
              v-model="currentLevel[(videos?.dataOfKey as any)?.toLowerCase()]" 
               :placeholder="classLevelPlaceholder"
              :list="Array.from(getLevels(videos.data)).map((lvl) => ({
                id: lvl,
                name: lvl,
              }))
                " />
    ...
    <div id="main-container" tabindex="-1" v-else-if="activeTab === 'audio'">
      <div v-for="(audios, index) in normalizedGroups" :key="index">
        <div v-if="
        ...
        <div v-else-if="showGroupHeader(audios) && !seeMoreDetails" class="flex items-center justify-between py-4">
          <p class="font-bold text-[1.3rem] capitalize">
            {{ (audios?.dataOfKey as any)?.toLowerCase() }}
          </p>
          <div class="flex items-center gap-2">
            ...
            <CustomDropDownList v-if="Array.from(getLevels(audios.data)).length > 1" class="px-2 cursor-pointer"
              v-model="currentLevel[(audios?.dataOfKey as any)?.toLowerCase()]" placeholder="select class level" :list="Array.from(getLevels(audios.data)).map((lvl) => ({
                id: lvl,
                name: lvl,
              }))
                " />
        ...
        <div v-if="hasMultipleGroups">
          ...
          <div v-else-if="!seeMoreDetails" :class="[
            ...
            <AudioCard v-for="audio in (() => {
              ...
              :audio-thumbnail="audio.thumbnail" :audio-file-url="audio.audioFileUrl"
              :audio-description="audio.description" :audio-subject="audio.subject?.name" :audio-type="audio.audioType"
              :alt-text="audio.alt" />
          </div>
        </div>
        <customGridOne v-else>
          ...
          <div class="flex items-center gap-2">
            ...
            <CustomDropDownList v-if="Array.from(getLevels(audios.data)).length > 1" class="px-2 cursor-pointer"
              v-model="currentLevel[(audios?.dataOfKey as any)?.toLowerCase()]" 
               :placeholder="classLevelPlaceholder"
              :list="Array.from(getLevels(audios.data)).map((lvl) => ({
                id: lvl,
                name: lvl,
              }))
                " />
