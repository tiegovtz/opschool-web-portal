...
import type { HotspotInteraction } from '~/types/interactive-video.interface'
...
const emit = defineEmits<{
  click: [interaction: HotspotInteraction]
}>()

const position = computed(() => props.interaction.position)
const ariaLabel = computed(() => props.interaction.title || props.interaction.content || 'Hotspot')
