export default defineNuxtPlugin((nuxtApp) => {
  ...
  router.beforeEach((to, from) => {
    ...
    const allowList = ["/profile", "/feedback", "/smart-class","/smart-class/screen/live-view","/smart-class/screen/live-tv","/smart-class/screen/recorded-sessions", "/smart-class/screen/live-classes","/smart-class/screen/upcoming-classes", "/tie-ai-teacher","/home#content-container-after-login"];
