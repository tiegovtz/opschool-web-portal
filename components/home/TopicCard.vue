...
<template>
  ...
  <NuxtLink
    ...
    class="relative overflow-hidden rounded-lg flex flex-col shadow-md pb-4 group"
    ...
    <!-- topic information -->
    <div class="bg-white flex-1 group-hover:bg-deepBlue px-4 group-hover:text-white transition-all duration-500 ease-in-out">
      <!-- topic progress bar -->
      ...
      <div
        class="flex flex-col my-auto    transition-all duration-500 ease-in-out">
      ...
      <div v-if=" modelType === 'card' "
        class="flex items-center justify-between pt-2 whitespace-nowrap text-extraSmall text-oceanBlue">
