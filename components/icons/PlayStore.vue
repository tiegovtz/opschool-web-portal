<template>
    ...
    <svg
      ...
      xml:space="preserve"
    >
      <title>Get this App on PlayStore</title>
      <path
      id="upper-start-tri"
          fill="#32BBFF"
  ...
  .play-store:hover path#lower-start-tri {
    fill: #32bbff;
  }
  .play-store:hover path#lower-mid-tri {
    fill: #29cc5e;
  }
  .play-store:hover path#upper-mid-tri {
    fill: #d93f21;
  }
  .play-store:hover path#pointer1 {
    fill: #ffaa00;
  }
  .play-store:hover path#pointer2 {
    fill: #ffd500;
  }
  </style>