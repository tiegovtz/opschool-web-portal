...
<template>
  <!-- Header -->
  <header class="relative shadow-sm bg-grayLight">
    <nav class="flex flex-col items-center wrapper-container">
      <!-- Header -->
      <div
        class="relative w-full h-24 mt-1 bg-[url('/public/flag/Flag_of_Tanzania.gif')] bg-cover bg-center bg-no-repeat"
      >
        <div
          class="absolute top-0 left-0 z-0 w-full h-full bg-white opacity-75"
        ></div>
        <div
        ...
        >
          <NuxtLink
            to="/"
            class="flex items-center justify-center bg-grayLight w-18 h-[96px]"
          >
            <NuxtImg
          ...
          <div
            class="flex flex-col items-center h-full gap-1 text-center uppercase font-tahomabd"
          >
          ...
          <NuxtLink
            to="/"
            class="flex items-center justify-center h-full p-2 cursor-pointer bg-grayLight"
          >
            <NuxtImg
              src="/logo/logo_tie.webp"
              alt="TIE LOGO"
              class="w-14 h-14"
            />
          </NuxtLink>
      ...
      <div class="w-full info">
        <!-- Media Screen -->
        <div
          class="flex-col items-center hidden w-full gap-2 text-white md:flex md:flex-row bg-oceanBlue rounded-xs"
        >
        ...
        >
          ...
          <div class="flex items-center justify-between w-full">
            ...
            <div class="flex items-center">
              <div
                class="flex items-center h-6 gap-2 p-2 cursor-pointer md:h-8"
                @click="logout"
                v-if="userToken"
              >
                <Icon
