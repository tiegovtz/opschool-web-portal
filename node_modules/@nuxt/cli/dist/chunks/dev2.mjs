...
import { a as clearBuildDir } from '../shared/cli.Cq7UtB4B.mjs';
import { l as loadKit } from '../shared/cli.DlcAx0De.mjs';
import { a as logger } from '../shared/cli.DC_SLyGm.mjs';
import { l as loadNuxtManifest, r as resolveNuxtManifest, w as writeNuxtManifest } from '../shared/cli.BkTWBcQK.mjs';
import 'node:fs';
import 'node:path';
import 'citty';
import 'std-env';
...
class NuxtDevServer extends EventEmitter {
  ...
  async _load(reload, reason) {
    ...
    this.options.overrides = defu(this.options.overrides, _getDevServerOverrides({}, await this.listener.getURLs().then((r) => r.map((r2) => r2.url))));
...
function _getDevServerOverrides(listenOptions, urls = []) {
...
export { _getDevServerOverrides, createNuxtDevServer };
