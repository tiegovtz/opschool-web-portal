...
`)}}const t=X(()=>r(e.from,e.to));function u(f){let l=0;return f.replace(/class="shiki/,'class="shiki diff').replace(/class="line"/g,s=>(l++,t.value.added.includes(l-1)?'class="line line-added"':t.value.removed.includes(l-1)?'class="line line-removed"':s))}const o=Y();j(i);function i(){const f=Q(o);f&&f.querySelector(".line-added,.line-removed")?.scrollIntoView()}return(f,l)=>{const s=P;return S(),W(s,{ref_key:"elRef",ref:o,code:t.value.result,lang:f.lang,"transform-rendered":u,onLoaded:i},null,8,["code","lang"])}}});export{le as _};
