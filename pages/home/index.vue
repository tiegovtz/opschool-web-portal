        ...
        <div class="w-full xl:w-3/4">
          ...
          >
            <ClientOnly>
              ...
              <customGridOne
                v-else-if="activeTab.toLowerCase() === 'interactive books'" v-trusted
              >
                <template #data>
              ...
              <customGridOne
                v-else-if="activeTab.toLowerCase() === 'experiments'" v-trusted
              >
                <template #data>
          ...
          >
            <ClientOnly>
              <HomeCustomScrollView
                ...
                :data="data"
                :active-tab="activeTab" v-trusted
